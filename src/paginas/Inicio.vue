...
<template>
  <div id="contenedorInicio">
    <h1>Antonia Bustamante</h1>
    <div id="contenedor_bio">
      <p class="columna">
      ...
      <p class="columna">
        Soy programadora e ingeniera de sonido, nací y vivo en Bogotá (Colombia). Mi práctica creativa se centra en la
